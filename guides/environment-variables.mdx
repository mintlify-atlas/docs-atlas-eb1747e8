---
title: "Environment Variables Reference for Zippi"
...
Redis serves as both the Celery message broker and the task result backend. All three variables default to the same local Redis instance.

| Variable                | Default                        | Required | Description                                                               |
| ----------------------- | ------------------------------ | -------- | ------------------------------------------------------------------------- |
| `REDIS_URL`             | `redis://127.0.0.1:6379/0`     | No       | Redis connection URL used by the application layer.                       |
