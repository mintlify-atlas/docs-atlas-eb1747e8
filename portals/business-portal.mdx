...
description: "The Business Portal gives business_owner and business_admin roles a dashboard, catalog, order tracking, branch management, and settlement reports."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Kitchen Queue" icon="fire-burner">
  ...
  <Card title="Waiter Floor" icon="utensils">
