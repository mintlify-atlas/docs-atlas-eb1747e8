---
title: "Permission Model and RBAC in Zippi"
sidebarTitle: "Permissions"
description: "Zippi uses action-level permissions beyond module access. catalog.manage implies fine-grained catalog actions; order transitions each require their own permission."
---
...
| Assumption | Reality |
|-----------|---------|
| `kitchen_staff` does not have `orders.manage` | **Wrong** — kitchen needs `orders.manage` to advance preparation |
