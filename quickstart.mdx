---
title: "Get Started with Zippi in Under 10 Minutes"
sidebarTitle: "Quickstart"
description: "Run the Zippi backend and frontend locally. Covers virtualenv setup, MySQL config, migrations, and the Vite dev server in 6 steps."
---
...
<Steps>
  <Step title="Clone the repo and verify prerequisites">
    ...
    **Required dependencies:**
    ...
    |-----------|----------------|-------|
    | Python | 3.11 | 3.10 also works per backend README |
