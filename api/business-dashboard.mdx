---
title: "Business Dashboard and Analytics API Reference"
sidebarTitle: "Dashboard"
description: "GET /api/v1/business/dashboard — Returns live operational metrics: active orders, revenue, branch status, and recent activity for the authenticated business scope."
---
