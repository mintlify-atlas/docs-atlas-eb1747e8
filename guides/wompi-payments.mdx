...
description: "Set up Wompi for card, PSE, and cash payments. Configure sandbox and production keys, verify TRANSACTION.UPDATED webhooks, and handle idempotent retries."
---
