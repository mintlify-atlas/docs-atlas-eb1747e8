---
title: "Products and Catalog Management API Reference"
sidebarTitle: "Products & Catalog"
description: "CRUD endpoints for products, categories, and add-on options. Action-level permissions control who can edit prices, images, availability, or archive items."
---
...
Returns all add-on option groups for the business scope.
