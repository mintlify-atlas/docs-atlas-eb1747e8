...
description: "Zippi uses JWT access/refresh tokens. Login returns both; access tokens expire in 4 minutes, refresh tokens in 30 days. Pass the Bearer token in the Authorization header."
---
...
<ResponseField name="role" type="string">
  Normalized role key (e.g., `city_admin`, `super_admin`). See the role keys in [Admin Users](/api/admin-users).
</ResponseField>
